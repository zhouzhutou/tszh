...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#book_to_read_table").bootstrapTable({
            url: '/tszh/exchangeBook/doSearchToReadBooks',
...
<ol class="breadcrumb" style="padding-left: 0">
    ...
    <li><a href="${pageContext.request.contextPath}/home/toReadBooks" name="navbar2">待阅图书</a></li>
</ol>
<div class="row">
...
<div class="row">
    <div class="col-md-10 col-sm-10">
        <table id="book_to_read_table"></table>
    </div>
</div>