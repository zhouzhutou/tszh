                           ...
                           success:function (result) {
                               ...
                               if(res.code==2000){
                                   toastr.options.onHidden=function () {
                                       window.location.href="/tszh/admin/accountInfo";
                                   };
...
<ol class="breadcrumb" style="padding-left: 0">
    ...
    <li><a href="${pageContext.request.contextPath}/admin/accountInfo" name="navbar2">账户信息</a></li>
    <li><a href="${pageContext.request.contextPath}/admin/accountInfo/editAccountInfo" name="navbar2">修改个人信息</a></li>
</ol>
<div class="row">
